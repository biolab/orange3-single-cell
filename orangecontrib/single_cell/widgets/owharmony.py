...
from orangecontrib.single_cell.preprocess.harmony_preprocess import HarmonyNormalizer
...
class OWHarmony(OWWidget):
    name = "Harmony"
    description = "Batch effect removal with Harmony on Single Cell data set."
    ...
    def __init__(self, parent=None):
        ...
        gui.widgetLabel(method_box, "Harmony")

        # --- Harmony tunable parameters ---
        gui.doubleSpin(
            method_box, self, "sigma",
            minv=0.01, maxv=10.0, step=0.05,
            label="Sigma:",
            decimals=3,
    ...
    def commit(self):
        ...
        try:
            batch_vars = [v.name for v in self.batch_vars]
